...
# Création du spectre de couleurs
...
wavelengths = np.linspace(x_min_global, x_max_global, 400)
rgb_colors = [wavelength_to_rgb(wl) for wl in wavelengths]
